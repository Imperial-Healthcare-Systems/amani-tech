    ...
    <article className={`job-card ${j.is_featured ? 'is-featured' : ''}`}>
      <div className="top">
        ...
        <div className="badges">
          {j.is_featured && <span className="badge badge-featured">Featured</span>}
      ...
      <div className="foot"><span>Posted {timeAgo(j.published_at)}</span><Link className="btn btn-outline btn-sm" href={href}>View Job</Link></div>
    </article>
  );
}
