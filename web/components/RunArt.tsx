  ...
  return (
    <defs>
      <linearGradient id={`${id}-glass`} x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#FFFFFF" stopOpacity=".97" /><stop offset="1" stopColor="#DCEFFF" stopOpacity=".86" />
      </linearGradient>
      <linearGradient id={`${id}-pane`} x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#F6FBFF" /><stop offset="1" stopColor="#D5ECFF" />
      </linearGradient>
      ...
      <linearGradient id={`${id}-print`} x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stopColor="#6FBEF3" /><stop offset="1" stopColor="#2A87D7" />
      </linearGradient>
...
export function RunArt({ name }: { name: string }) {
  ...
  if (name === 'plan') return (
    <svg {...box}><Defs id={id} />
      ...
      <path d="M18 87 L92 57" stroke="#A9DCFF" strokeWidth="2.6" strokeLinecap="round" opacity=".75" />
      {/* the pen */}
  ...
  if (name === 'establish') return (
    <svg {...box}><Defs id={id} />
      ...
      <Box x={64} y={106} w={20} h={22} d={9} left={`url(#${id}-glass)`} right="#D3EAFF" top="#EEF7FF" />
      <Box x={104} y={100} w={22} h={70} d={10} left={`url(#${id}-glass)`} right="#CFE8FF" top="#F1F9FF" />
  ...
  if (name === 'staff') return (
    <svg {...box}><Defs id={id} />
      ...
      <g stroke="#B9DEFF" strokeWidth="1.3" strokeDasharray="3 4" fill="none">
      ...
      <rect x="155" y="30" width="16" height="4" rx="2" fill="#E2F1FF" />
    </svg>
  );
  ...
  if (name === 'operate') return (
    <svg {...box}><Defs id={id} />
      ...
      <g stroke="#B9DEFF" strokeWidth="1.3" strokeDasharray="3 4" fill="none"><path d="M122 62 L140 70" /></g>
      <Box x={162} y={112} w={20} h={12} d={9} left={`url(#${id}-glass)`} right="#CFE8FF" top="#EEF7FF" />
      <Box x={162} y={98} w={20} h={12} d={9} left={`url(#${id}-glass)`} right="#CFE8FF" top="#EEF7FF" />
  ...
  return (
    <svg {...box}><Defs id={id} />
      <ellipse cx="100" cy="110" rx="84" ry="16" fill={`url(#${id}-glow)`} />
      <rect x="20" y="40" width="44" height="58" rx="6" fill="#E8F5FF" stroke={STEEL} transform="rotate(-6 42 69)" />
      ...
      <Box x={164} y={110} w={22} h={56} d={10} left={`url(#${id}-glass)`} right="#CFE8FF" top="#F1F9FF" />
