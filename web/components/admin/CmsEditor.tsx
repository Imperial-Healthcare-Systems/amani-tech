    ...
    <>
      ...
      {sec === 'hero' && <div className="a-form-layout">
        <div className="a-card"><h3>Hero section</h3>
          ...
          <div className="field"><label htmlFor="h-heading">Heading</label><input className="input" id="h-heading" value={hero.payload.heading} onChange={e => H({ ...hero, payload: { ...hero.payload, heading: e.target.value } })} /><span className="hint">The part below is highlighted in blue.</span></div>
          ...
          <div className="form-grid">
            <div className="field"><label htmlFor="h-cta">Primary button text (links to /jobs)</label><input className="input" id="h-cta" value={hero.payload.primary_cta} onChange={e => H({ ...hero, payload: { ...hero.payload, primary_cta: e.target.value } })} /></div>
            <div className="field"><label htmlFor="h-cta2">Secondary button text</label><input className="input" id="h-cta2" value={hero.payload.secondary_cta} onChange={e => H({ ...hero, payload: { ...hero.payload, secondary_cta: e.target.value } })} /></div>
            <div className="field span-2"><label htmlFor="h-cta2u">Secondary button URL</label><input className="input" id="h-cta2u" value={hero.payload.secondary_url} onChange={e => H({ ...hero, payload: { ...hero.payload, secondary_url: e.target.value } })} /></div>
          </div>
          <ImagePicker label="Hero illustration (right side of the hero)" prefix="hero" value={hero.payload.image || ''} onChange={url => H({ ...hero, payload: { ...hero.payload, image: url } })} />
