...
import { Enter, Item, Stagger } from '@/components/motion';
...
export default async function BlogPage({ searchParams }: { searchParams: Promise<{ category?: string }> }) {
  ...
  return (
    <>
      <section className="page-hero"><div className="container"><Enter><span className="eyebrow">Resources</span></Enter><Enter delay={0.08}><h1>Insights and career advice</h1></Enter><Enter delay={0.16}><p className="lead">Practical writing from recruiters who talk to candidates and employers every day.</p></Enter></div></section>
