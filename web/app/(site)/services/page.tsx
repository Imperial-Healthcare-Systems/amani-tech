...
const PRACTICES = [
  ['zap', 'IT Consulting', 'AI and automation, cloud and DevOps, cybersecurity, custom software and data — enterprise-grade delivery sized for SMBs.', '/services/it-consulting', 'Explore IT consulting'],
  ['globe', 'GCC Practice', 'A complete landing partner for North American enterprises setting up a capability center in Hyderabad — entity, office, compliance and team.', '/gcc', 'See the GCC practice'],
  ['graduation', 'Training & LMS', 'Corporate upskilling tracks built around live hiring demand. The learning portal is coming soon.', '/lms', 'Register your interest'],
] as const;
  ...
  return (
    <>
      ...
      <section className="section section-alt"><div className="container">
        <Reveal><div className="section-head"><span className="eyebrow">Beyond staffing</span><h2>Our other practices</h2><p className="lead">Hiring is where most clients start. These practices take over when the need is technology, a new India presence, or training.</p></div></Reveal>
        <Stagger className="grid grid-3">{PRACTICES.map(([i, t, d, href, cta]) => (
          <Item key={t}><Link className="practice-card" href={href}>
